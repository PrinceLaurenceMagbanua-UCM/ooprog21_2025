public class StringBuilderDemo {
 public static void main(String[]args) {
   ...
   System.out.println("Capacity of addrressString is " + addressString.capacity());
   
   nameString.setLength(20);
   addressString.setLength(20);
   
   System.out.println("\n lenght set to 20 for StringBuilder 1) The name is " + nameString );
   System.out.println("\n lenght set to 20 for StringBuilder 2) The name is " + addressString);
